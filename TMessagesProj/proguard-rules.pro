...
-keepclassmembernames,allowshrinking class tw.fdw.makrotagram.MessageDetailsActivity$TextDetailSimpleCell { <fields>; }
-keepclassmembernames,allowshrinking class tw.fdw.makrotagram.settings.AccountCell { <fields>; }
-keepclassmembernames,allowshrinking class tw.fdw.makrotagram.settings.EmojiSetCell { <fields>; }
-keepclassmembernames,allowshrinking class tw.fdw.makrotagram.settings.NekoChatSettingsActivity$StickerSizeCell { <fields>; }
